...
This privacy policy applies to the **SepiaPod app (hereby referred to as "Application")** for mobile devices that was created by **Kazuki Awasawa (hereby referred to as "Service Provider")** as a Free service. This service is intended for use "AS IS".
...
Please note that Apple's iOS platform may collect crash reports and diagnostic data based on your consent. Such data is processed in accordance with Apple's Privacy Policy, and the Service Provider may view anonymized, aggregated statistics through App Store Connect.
...
If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at [support.kawasawa@icloud.com](mailto:support.kawasawa@icloud.com).
